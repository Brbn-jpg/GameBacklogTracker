...
const StatsCard = ({ title, value, subtext, icon, color }) => {
  return (
    <div className="bg-white dark:bg-black neo-border-thick dark:border-white neo-shadow dark:neo-shadow-white p-4 md:p-6 flex items-center transition-colors">
